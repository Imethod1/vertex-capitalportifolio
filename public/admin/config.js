const config = {
  backend: {
    ...
    app_secret: process.env.DECAP_CMS_GITHUB_APP_SECRET,
  },
          ...
          fields: [
            {
              ...
              fields: [
                ...
                },
                {
                  ...
                  name: 'status',
                  widget: 'select',
                  options: ['Compliant', 'Warning', 'Breach'],
                },
                {
